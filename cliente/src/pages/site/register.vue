      ...
      <b-col lg="12">
        <div class="login">
          ...
          <div class="title mtop mbottom">
            <span>Digite seus dados abaixo para ingressar na plataforma.</span>
          </div>
          <form v-on:submit.prevent="register()">
            ...
            <div class="input-group mb-3">
              ...
              <b-form-input v-model="form.email" type="email" placeholder="Digite seu e-mail" autocomplete="on"></b-form-input>
            </div>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
              ...
              <b-form-input type="password" v-model="form.password" placeholder="Digite sua senha" autocomplete="current-password"></b-form-input>
            </div>
            <div class="checkboxes">
              <b-form-checkbox v-model="form.selected" name="remember">
                <span>Concordo com os <span class="orange">Termos de Uso</span> e <span class="orange">Politica de Privacidade</span></span>
              </b-form-checkbox>
            </div>
          ...
          <div class="title mtop mbottom">
            <span>Já tem uma conta? <a href="/#/login" class="orange"><b>Logue-se</b></a></span>
          </div>
          <div class="btn-border-blue">
            <b-button>
              <font-awesome-icon :icon="['fab', 'facebook']" /> Cadastrar com Facebook </b-button>
          </div>
        </div>
      </b-col>
    </b-row>

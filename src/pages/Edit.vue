                    ...
                    <md-dialog :md-active.sync="showDialog">
                        ...
                        <md-dialog-content>
                            ...
                            <md-field>
                                ...
                                <md-input v-model="title" name="title" required></md-input>
                    ...
                    <div class="md-layout-item md-small-size-100 md-medium-size-50 md-large-size-33 md-size-25">
                        ...
                        <md-card-media-cover md-solid>
                            <md-card-media md-ratio="1:1">
                                <img src="https://cb2.scene7.com/is/image/CB2/BlackClayMug8ozSHF16/?$web_product_hero$&170502150906&wid=625&hei=625">
                            </md-card-media>
                            <md-card-area>

...
export default {
  ...
  validations: {
    ...
    methods: {
      loadFaq() {
        global.$get("/Content/getfaq?campaign_id=" + this.$route.params.id, {}, this.user.token)
          .then(res => {
      ...
      addFaq() {
        ...
        if (!this.$v.faq.$invalid) {
          ...
          global.$post("/Content/addfaq", data, this.user.token)
            .then(res => {
              this.resetFaq();
              this.loadFaq();
            })
      ...
      deleteFaq(id) {
        ...
        global.$post("/Content/deletefaq", data, this.user.token)
          .then(res => {
            this.loadFaq();
          })
          .catch(err => {
      ...
      editFaq() {
        ...
        if (!this.$v.faqEdit.$invalid) {
          ...
          global.$post("/Content/editfaq", data, this.user.token)
            .then(res => {
              this.loadFaq();
              this.resetFaq();
            })

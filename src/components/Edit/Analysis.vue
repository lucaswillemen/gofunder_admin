...
<main>
  <div class="md-layout-item md-small-size-100 md-size-100">
    <md-card>
      <md-empty-state style="padding-bottom: 0 !important;" md-icon="find_in_page" md-label="Publique sua campanha!"
        md-description="Aqui você concorda que finalizou todas as edições da campanha e a envia para nossos profissionais analisarem para você!"></md-empty-state>
      ...
      <md-card-actions>
        <md-button class="md-raised preview-btn" @click="previewCampaign()">Pré Visualizar Campanha</md-button>
